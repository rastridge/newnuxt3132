    ...
    <div class="my-simple-card-style">
      <div class="flex flex-row flex-wrap justify-content-center">
        ...
        >
          <template #title
            ><div class="my-text-style text-center">
              2021,22,23 Holiday Adopt-a-Family
            </div></template
          >
          <template #content
            >Partnered with the Legal Aid Bureau of Buffalo, they are the
            largest provider of Indigent Legal Services in Buffalo. They also
            represent children going through Family Court. Very High risk
            population. We've done this for 3 years now adopting around 30
        ...
        >
          <template #title
            ><div class="my-text-style text-center">
              2023 - Turkey Drive - 58 Turkeys for FeedMoreWNY
            </div></template
          >
          <template #content
            ><img
        ...
        >
          ...
          >
          <template #content> 36 Turkeys for FeedMoreWNY </template>
        </Card>
        ...
        <Card class="w-full">
          ...
          <template #content>
            <div class="my-text-style">
              Since 2011 the Buffalo Rugby Club has volunteered one day each
              year for Habitat for Humanity. Our specialty is tear out. That
              means taking out the walls, ceilings, door and window frames, old
              wiring and pipes from a house that has been obtained by Habitat
              for Humanity for renovation. It is the first step in the
              renovation of a home by HFH volunteers. Potential homeowners must
              put in 500 hours of work to be eligible for a no interest
              mortgage. For more information visit
              <a href="http://www.habitatbuffalo.org/">Habitat for Humanity</a>
            </div></template
          >
        </Card>
        <Card
