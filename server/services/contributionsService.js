...
async function addOne({
  ...
  try {
    ...
    const msg =
      ...
      ', Thank you for your contribution to the Buffalo Rugby Club Alumni Fund. We are a NYS 501 C3 organization and as such your donation is tax deductible. This email serves as a record that you donated $' +
      contribution_amount +
